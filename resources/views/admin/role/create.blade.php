...
<div class="row">
	...
	<div class="col-md-12 col-sm-12 ">
		...
		<div class="x_panel">
			...
			@include('admin.element.urlmenu', ['url'=>'admin.role','name'=>'role', 'key'=>'add'])
			...
			<div class="x_content">
				...
				<form id="demo-form2" action="store" method="post" class="form-horizontal form-label-left" novalidate="">
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 ">
							<input name="display_name" type="text" id="first-name" required="required" class="form-control " value="">
						</div>
											...
											<div class="col-md-3">
												  ...
												  <div class="card-body">
												    <blockquote class="blockquote mb-0">
												    	<label for="">
												  		<input class="checkbox_child" name="permission_id[]" value="{{ $value->id }}" type="checkbox">
												  	</label>
												      {{ $value->name }}
