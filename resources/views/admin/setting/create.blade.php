...
<div class="row">
	...
	<div class="col-md-12 col-sm-12 ">
		...
		<div class="x_panel">
			...
			@include('admin.element.urlmenu', ['url'=>'admin.setting','name'=>'setting', 'key'=>'add'])
				...
				<form id="demo-form2" action="store" method="post" class="form-horizontal form-label-left" novalidate="" enctype='multipart/form-data'>
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 ">
							<input name="config_key" type="text" id="first-name" required="required" class="form-control " value="">
						</div>
					...
					<div class="item form-group">
						...
						@if(Request()->type == 'text')
							<div class="col-md-6 col-sm-6 ">
								<input name="config_value" type="text" id="first-name" required="required" class="form-control " value="">
							</div>
						@elseif(Request()->type == 'textarea')

						<div class="col-md-6 col-sm-6 ">
							<textarea name="config_value" class="form-control" id="editor1" rows="3">{{ old('config_value') }}</textarea>
						</div>
						@endif
