...
<div class="row">
	...
	<div class="col-md-12 col-sm-12 ">
		...
		<div class="x_panel">
			...
			@include('admin.element.urlmenu', ['url'=>'admin.menu','name'=>'menu', 'key'=>'edit'])


			<div class="x_content">

				<br>
				<form id="demo-form2" action="{{ route('admin.menu.update', ['id'=>$item->id]) }}" method="post" class="form-horizontal form-label-left" novalidate="">
					<!-- //error -->
					...
					<div class="form-group row">
						...
						<div class="col-md-6 col-sm-6 ">
							<select class="form-control" name="parent_id">
								...
								{!! App\helpers\Helper::selecboxMenu($menu, null, null, $item->parent_id) !!}
							</select>
						</div>
